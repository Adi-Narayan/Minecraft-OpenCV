...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            # If you want to get the nose landmarks and make that as a mouse tracker
            ...
            if knee_y < (hip_y + 50) and squat == False:
                squat = True
                pdi.keyDown('leftctrl')

            elif knee_y > hip_y and squat == True:
                squat = False
                pdi.keyUp('leftctrl')
            ...
            if elbow_y > wrist_y and jump == False and results.pose_landmarks.landmark[
            ...
            elif angle2 > 130 and angle1 < 70 and click == True:
                click = False
                if click_hold == False:
                    # pdi.leftClick()
                    pdi.mouseDown()
            ...
            if results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_ANKLE].y < (
                    ...
                    results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_KNEE].y) / 2 and walk == False:
                walk = True
                pdi.keyDown('w')
            elif results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_ANKLE].y > (
                    results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_ANKLE].y +
                    results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_KNEE].y) / 2 and walk == True:
                walk = False
                pdi.keyUp('w')
            ...
            if results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_ANKLE].y < (
                    ...
                    results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_KNEE].y) / 2 and spacehold == False:
                spacehold = True
                pdi.keyDown('w')
                pdi.keyDown('leftshift')
                pdi.keyDown('space')
            ...
            if results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_ELBOW].y < (
                    ...
                    results.pose_landmarks.landmark[
                        mp_pose.PoseLandmark.RIGHT_SHOULDER].y - normalfactor) and right == False:
                right = True
                ...
                (results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_SHOULDER].y + normalfactor) and right == True:
                right = False
                try:
                    poll = moveright.poll()
                    if poll is None:
            ...
            if results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_ELBOW].y < (
               results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_SHOULDER].y + normalfactor) and \
               results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_ELBOW].y > (
               results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_SHOULDER].y - normalfactor) and left == False:
                left = True
